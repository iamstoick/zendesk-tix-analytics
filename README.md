...
2. Start the local server: `zat server`. If you don't have ZAT yet, you can install it in your machine by following [this guide](https://developer.zendesk.com/documentation/apps/zendesk-app-tools-zat/installing-and-using-zat/).
